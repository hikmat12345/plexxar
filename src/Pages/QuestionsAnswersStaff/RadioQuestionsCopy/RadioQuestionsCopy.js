...
const radio_blank = getFileSrcFromPublicFolder("radio_button_blank.png");
const radio_checked = getFileSrcFromPublicFolder("radio_button_checked.png");
...
const RadioQuestionsCopy = ({ question, callback, subQuestionsAnswers }) => {
  ...
  }, [question.qid, subAnswers, subAnswers.length, subQuestionsAnswers]);
