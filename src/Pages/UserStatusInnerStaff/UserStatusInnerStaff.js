...
//src
import { getUserStatus, ActiveInactiveStaff } from "./actions";
import { objectIsEmpty, getCookies, setCookies } from "../../utils";
import history from "../../history";
import PlexaarContainer from "../PlexaarContainer";
import Loader from "../Loader";

//scss
import "./UserStatusInnerStaff.scss";
import { useLocation } from "react-router-dom/cjs/react-router-dom.min";

const UserStatusInnerStaff = () => {
  ...
  const userName = getCookies("staffDetail").name;
  const accountNumber = getCookies("staffDetail").accountNumber;
  ...
  return (
          ...
          <div className="staff-onboard-profile">
            ...
            <div className="profile">
              ...
              <div>
                ...
                <FAEText style={{ color: "#787878" }}>{accountNumber}</FAEText>
              </div>
            </div>
            <div>
              <Switch
    ...
    //       Your Status
    //     </FAEText>
    //     <div className="staff-back-btn" style={{ width: "100%" }}>
    //       <FAEButton
    //         onClick={() =>
    //           history.push({
    //             pathname: "/your-staff",
...
export default PlexaarContainer(UserStatusInnerStaff);
